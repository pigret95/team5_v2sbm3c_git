    ...
    <UL>
      <c:choose>
        <c:when test="${param.cnt == 1}">
          <LI class='li_none'>
            <span class="span_success">이벤트를 수정했습니다.</span>
          </LI>
        </c:when>
        <c:otherwise>
          <LI class='li_none_left'>
            <span class="span_fail">이벤트 수정에 실패했습니다.</span>
          </LI>
          <LI class='li_none_left'>
      ...
      <LI class='li_none'>
        ...
        <button type='button' onclick="location.href='./list_search.do'" class="btn btn-primary">목록</button>
      </LI>
    </UL>
  </fieldset>
