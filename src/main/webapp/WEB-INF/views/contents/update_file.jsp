...
<jsp:include page="../menu/top.jsp" flush='false' />
 <DIV class='content_body'>
  ...
  <ASIDE class="aside_right">
    ...
    <span class='menu_divide' >│</span>
    <A href="./list_by_bookno_search_paging.do?bookno=${bookVO.bookno }&now_page=${param.now_page}">목록</A>    
    <span class='menu_divide' >│</span>
    ...
    <form name='frm' id='frm' method='get' action='./list_by_cateno_search.do'>
      ...
      <c:if test="${param.word.length() > 0 }">
        <button type='button' 
                     onclick="location.href='./list_by_cateno_search.do?bookno=${bookVO.bookno}&word='">검색 취소</button>  
      </c:if>    
    </form>
  </DIV>
