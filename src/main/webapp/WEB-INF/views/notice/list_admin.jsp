...
<DIV class='title_line'>
  <A href="../event/list.do" class='title_link'>공지사항</A>
   ...
   <span><A class='menu_link'
    ...
    <A class="menu_link" href="./create.do">등록</A>
  </ASIDE> 
</DIV>
    ...
    <c:forEach var="noticeVO" items="${list}">
      ...
      <TR>
        ...
        <TD class="text-center">
          <A href="./update.do?noticeno=${noticeno }" title="수정"><span class="glyphicon glyphicon-pencil"></span></A>
          <A href="./delete.do?noticeno=${noticeno }" title="삭제"><span class="glyphicon glyphicon-trash"></span></A>
        </TD>   
      </TR>   
    </c:forEach> 
    </tbody>   
